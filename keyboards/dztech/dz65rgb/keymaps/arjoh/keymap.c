...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_CONTROL] = LAYOUT_65_ansi(
        ...
        _______, RGB_TOG, RGB_MOD, RGB_HUI, RGB_HUD, RGB_SAI, RGB_SAD, RGB_VAI, RGB_VAD, _______, KC_PSCR, KC_SCRL, KC_PAUS, QK_BOOT,   TG(4),
...
bool rgb_matrix_indicators_user(void) {
    ...
    bool g_suspend_state = rgb_matrix_get_suspend_state();
